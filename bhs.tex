...
We emphasize that our goal is to compare a pure interior point method versus the pure augmented Lagrangian method proposed, without sophisticated accelerations and safeguards. This explains the overall mildly poor behavior of both methods. For instance, IPOPT~\cite{Wachter:2005hk}, a well tuned interior point method, solves 56 of the 68 \texttt{small} problems of  \textsc{Netlib} collection when limited to 300 iterations~\cite{Haeser:2017wl}. Note also that the \textsc{Netlib} problems are somewhat difficult ones, as, for instance, no strict interior exists on circa 65\% of the problems [?].
